...
class AI85UNetSmall(nn.Module):
    ...
    def __init__(
            ...
            num_classes=3,  
            num_channels=3,
            dimensions=(1024, 1024),  # pylint: disable=unused-argument #(128, 128) is original size in MAX example, must be <32.7k pixels
            bias=True,
            **kwargs
    ):
        super().__init__()
...
def ai85unetsmall_be(pretrained=False, **kwargs):
    """
...
models = [
    {
        'name': 'ai85unetsmall_be',
        'min_input': 1,
        'dim': 2,
    },
    {
        'name': 'ai85unetmedium_be',
        'min_input': 1,
        'dim': 2,
    },
    {
        'name': 'ai85unetlarge_be',
        'min_input': 1,
        'dim': 2,
    },
]